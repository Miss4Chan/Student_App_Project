...
function editLocation(){
    ...
    edittype.innerText = document.getElementById("type").value;
    edittype.name=document.getElementById("type").value;
    edittype.value=document.getElementById("type").value;
    // edittype.value = document.getElementById("type").options[edittype.selectedIndex].value;;
